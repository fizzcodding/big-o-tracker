...
function activate(context) {
    ...
    try {
        const provider = new sidebarView_1.BigOSidebarView();
        const disposable = vscode.window.registerWebviewViewProvider("bigOView", // Use string literal to ensure it matches package.json
        provider, {
            webviewOptions: {
