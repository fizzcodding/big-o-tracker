...
exports.BigOSidebarView = void 0;
    ...
    resolveWebviewView(view, context, _token) {
        ...
        view.webview.onDidReceiveMessage(async (msg) => {
            ...
            try {
                ...
                const results = await (0, analyzerClient_1.analyzeSource)(source);
...
exports.BigOSidebarView = BigOSidebarView;
BigOSidebarView.viewType = "bigOView";
